...
within model size in the poupulation with four predictors (We use the notation 2YX to represent the proportion of
variance in Y that is accounted for by the predictors in
the model X.:
